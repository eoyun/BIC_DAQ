...
void quickQA(int RunNo = 60090, int nEvtToRead = 10000, const char* inPath = "./data"){
...
//--------------------------------------------------------------------------------------------------------
void astropix_daq_quickQA(int RunNo = 60096, int nEvtToRead = 10000, const char* inPath = "./data/", int mid = 41)
{
...
//--------------------------------------------------------------------------------------------------------
void bic_daq_quickQA(int RunNo = 2080, int nEvtToRead = 10000, const char* inPath = "./data", int mid = 42)
{
